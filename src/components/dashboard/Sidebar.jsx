        ...
        <section className="shadow-lg fixed h-screen bg-white">
            <nav className="w-60 flex flex-col my-3 p-5 min-h-screen">
                ...
                <ul className="text-md flex flex-col gap-3">
                    {/* Home Link */}
                    <Link to="/home" className={`flex items-center  gap-2 px-2 py-3 hover:bg-[#47cb18] hover:text-white : 'text-gray rounded-md ${isActive('/') ? 'bg-[#47cb18] text-white' : 'text-gray'}`}>
