...
const ArticleCard = () => {
    return (
        <div>
            <div className='hover:cursor-pointer hover:scale-110 transitin duration-300 bg-white p-3 shadow-md w-72 h-72 rounded-md overflow-hidden'>
                <div className="flex items-center gap-2 mb-3">
                    <div className="border-2 border-[#45c517] rounded-full">
                        <img
                            src="https://upload.wikimedia.org/wikipedia/commons/c/ca/JTV_%28Indonesian_TV_channel%29_2022.svg"
                            alt=""
                ...
                />
                <div className='mt-2'>
                    <p className="text-xs text-[#3ca315]">Politik</p>
