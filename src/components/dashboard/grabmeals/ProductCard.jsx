...
const ProductCard = ({ product }) => {
    return (
        <Link to={`/product/${product.id}`}>
            <div className="hover:scale-110 transition duration-300 hover:cursor-pointer w-48 bg-white rounded-md shadow-md">
                <div className="flex items-start">
                    <div className="p-2 w-full">
                        <div className='flex gap-3 mb-3 items-center'>
                            ...
                            <h1 className="font-semibold">{product.owner}</h1>
                        </div>
