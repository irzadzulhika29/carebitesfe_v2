...
const Payment = () => {
    ...
    const [quantity, setQuantity] = useState(1); // Jumlah produk yang dibeli
    const [total, setTotal] = useState(0); // Total harga berdasarkan jumlah
                    ...
                    <section className="min-h-screen mx-5">
                        <div className="p-6 rounded-lg ">
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-md">
                                <h2 className="mb-3 text-lg font-bold mb-4">Alamat Pengambilan</h2>
